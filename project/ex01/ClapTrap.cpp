...
void ClapTrap::takeDamage(unsigned int amount) {
    if (hitPoints == 0) {
        std::cout << "ClapTrap " << name << " can't take more damage because it already has no hit points left" << std::endl;
        return;
    }
    ...
    std::cout << "ClapTrap " << name << " takes " << damageTaken << " points of damage" << std::endl;
